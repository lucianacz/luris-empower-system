  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-12">
      <section className="w-full max-w-md rounded-[24px] border border-[var(--line)] bg-[var(--surface)] p-7 shadow-[0_24px_70px_rgba(37,45,42,0.09)] sm:p-9">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-[-0.04em]">Sign in without a password</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--muted)]">We send a one-time link to your email. Supabase Auth manages the session; your financial rows are protected by database policies.</p>
        <AuthForm />
      </section>
    </main>
  );
