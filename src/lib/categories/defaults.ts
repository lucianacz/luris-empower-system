...
export const defaultExpenseCategories: DefaultExpenseCategory[] = [
  ...
  { name: "Groceries", lifeArea: "Food", essential: true, color: "#52796f", pattern: /grocery|groceries|supermarket|supermercado|\bmini\s*super\b|\bminisuper\b|\bmega\s*super\b|\bsuper\b|market|mercado|verduler|carnicer|bakery|panader|panificadora|almac[eé]n|convenience|7-eleven|seven-eleven|city\s*mall|golden\s*mall|daily\s*mart|bm\s+rio\s+claro|lawson|whole\s*foods|wholefds|walmart|wm\s+supercenter|chedraui|abarrotes|soderia|marks\s*&\s*spencer\s+food|misuperprecio|\boxxo\b|\bopen\s*25\b|\bnewgarden\b/i },
  { name: "Dining out", lifeArea: "Food", essential: false, color: "#d37a3d", pattern: /restaurant|\brest\b|dining|food\s*&\s*dining|fast food|caf[eé]|coffee|bar\b|sushi|ramen|burger|pizza|poke\b|gelato|ice\s*cream|patisserie|a[cç]a[ií]|\bsoda\b|rappi|uber eats|delivery|mcdonald|starbucks|helader|\btaco\b|taquer[ií]a/i },
  ...
  { name: "Flights", parentName: "Travel", lifeArea: "Travel", essential: false, extraordinary: true, color: "#416788", pattern: /airline|airlines|aeroline|avianca|latam|lan airline|copa air|vivaaerobus|aeromexico|volaris|sansa|air transport/i },
  ...
  { name: "Pharmacy", parentName: "Health", lifeArea: "Health", essential: true, color: "#6f9d84", pattern: /pharmacy|farmacia|farmacity|farmplus|drogaria|\braia\d*\b/i },
  ...
  { name: "Shopping", lifeArea: "Lifestyle", essential: false, color: "#a26769", pattern: /clothing|apparel|department store|retail|amazon|mercadolibre|shopping|tienda|zara|ikea|electronics|best\s+buy|adidas|\btnf\b|hoka|sport\s+store|muji|opus\s+art\s+supplies|cellicon/i },
  ...
  { name: "Fuel & gas", parentName: "Car", lifeArea: "Mobility", essential: true, color: "#b56b36", pattern: /fuel|\bgas\b|gasolin|combustible|servicentro|gas station|lumicentro|terpel|racetrac|shell\s+oil|\bypf\b|\baxion\b|\bposto\b|\best(?:acion)?\s+serv\b/i },
