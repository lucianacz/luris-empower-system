...
export const defaultExpenseCategories: DefaultExpenseCategory[] = [
  ...
  { name: "Groceries", lifeArea: "Food", essential: true, color: "#52796f", pattern: /grocery|groceries|supermarket|supermercado|market|mercado|verduler|carnicer|bakery|panader|almac[eé]n|convenience|7-eleven|lawson|whole foods|walmart/i },
