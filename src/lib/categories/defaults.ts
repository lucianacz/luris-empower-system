...
export const defaultExpenseCategories: DefaultExpenseCategory[] = [
  ...
  { name: "Groceries", lifeArea: "Food", essential: true, color: "#52796f", pattern: /grocery|groceries|supermarket|supermercado|\bmini\s*super\b|\bminisuper\b|\bmega\s*super\b|\bsuper\b|market|mercado|verduler|carnicer|bakery|panader|almac[eé]n|convenience|7-eleven|seven-eleven|city\s*mall|golden\s*mall|daily\s*mart|bm\s+rio\s+claro|lawson|whole foods|walmart|\boxxo\b|\bopen\s*25\b|\bnewgarden\b/i },
  { name: "Dining out", lifeArea: "Food", essential: false, color: "#d37a3d", pattern: /restaurant|dining|food\s*&\s*dining|fast food|caf[eé]|coffee|bar\b|sushi|rappi|uber eats|delivery|mcdonald|starbucks|helader|\btaco\b|taquer[ií]a/i },
  ...
  { name: "Flights", parentName: "Travel", lifeArea: "Travel", essential: false, extraordinary: true, color: "#416788", pattern: /airline|airlines|aeroline|avianca|latam|lan airline|copa air|vivaaerobus|aeromexico|sansa|air transport/i },
  ...
  { name: "Fuel & gas", parentName: "Car", lifeArea: "Mobility", essential: true, color: "#b56b36", pattern: /fuel|\bgas\b|gasolin|combustible|servicentro|gas station|lumicentro|terpel|racetrac/i },
