...
export const knownMerchantRules: KnownMerchantRule[] = [
  ...
  { id: "whole-foods", pattern: /\bwhole\s*foods\b|\bwholefds\b/i, displayName: "Whole Foods", categoryName: "Groceries", countryCode: "US", recurrenceDenied: true, beneficiaryScope: "shared" },
  { id: "best-buy-shared", pattern: /\bbest\s+buy\s+0*5512\b/i, displayName: "Best Buy", categoryName: "Shopping", countryCode: "US", recurrenceDenied: true, beneficiaryScope: "shared", transactionLabel: "Shared household purchase" },
  { id: "aeromexico", pattern: /\baeromexico\b/i, displayName: "Aeromexico", categoryName: "Flights", recurrenceDenied: true, beneficiaryScope: "shared", transactionLabel: "Two shared flights · statement charge components" },
  { id: "volaris", pattern: /\bvolaris\b/i, displayName: "Volaris", categoryName: "Flights", recurrenceDenied: true, beneficiaryScope: "shared" },
  ...
  { id: "shell-oil", pattern: /\bshell\s+oil\b/i, displayName: "Shell Oil", categoryName: "Fuel & gas", countryCode: "US", recurrenceDenied: true, beneficiaryScope: "shared" },
  ...
  { id: "clarence-hostels", pattern: /\bthe\s+clarence\s+park\b|\bclarence\s+castle\s+inc\b/i, displayName: "The Clarence Park hostel", categoryName: "Hotels", countryCode: "CA", recurrenceDenied: true, beneficiaryScope: "personal", transactionLabel: "Canada work trip · hotel", notes: "Luciana's personal work trip to Canada, July 18–24, 2026." },
  ...
  { id: "partner-transfer-julian", pattern: /^(?:(?:payment|transfer(?:encia)?)\s+(?:to|from|a|de)\s+)?(?:\d{11}\s*-\s*)?julian(?:\s+aaron)?\s+stivelman\b/i, displayName: "Julian Stivelman", preserveDisplayName: true, categoryName: null, recurrenceDenied: true, beneficiaryScope: "personal", kind: "transfer", excludedFromTotals: true, transactionLabel: "Internal movement with Julian", notes: "Movement between Luciana and Julian; preserved for traceability and excluded from income and spending." },
