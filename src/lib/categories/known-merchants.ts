...
export const knownMerchantRules: KnownMerchantRule[] = [
  ...
  { id: "jazak-veematz", pattern: /\bjazak\s+veematz\s+ll\b/i, displayName: "Jazak VeEmatz LL · Julian's company", categoryName: null, recurrenceDenied: true, beneficiaryScope: "personal", kind: "transfer", excludedFromTotals: true, notes: "Movement involving Julian's company; kept visible and excluded from personal living expenses." },
  ...
  { id: "satu-lagi-baltodano", pattern: /\bbaltodano\s+gomez\s+martin\b/i, displayName: "Satu Lagi Villa · land", categoryName: "Satu Lagi Villa", recurrenceDenied: true, beneficiaryScope: "personal", kind: "investment_purchase", excludedFromTotals: true, notes: "Land payments financed by Luciana through Julian's Wise account; excluded from monthly living expenses." },
  { id: "satu-lagi-lawyer", pattern: /\bgutierrez\s+gonzalez\s+kaily\s+vanessa\b/i, displayName: "Satu Lagi Villa · legal", categoryName: "Satu Lagi Villa", recurrenceDenied: true, beneficiaryScope: "personal", kind: "investment_purchase", excludedFromTotals: true, notes: "Legal costs for Satu Lagi; excluded from monthly living expenses." },
